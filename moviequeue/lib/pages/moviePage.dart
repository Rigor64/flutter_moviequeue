...
class _MoviePageState extends ConsumerState<MoviePage> {
  late Future<List<Media>> discoverMovie;
  ...
  void initState() {
    ...
    discoverMovie = Api().getPopularMovies();
    super.initState();
  }
                                        ...
                                        case Swipe():
                                          {
                                            if (activity.direction ==
                                                AxisDirection.right) {
                                              debugPrint(
                                                  'Aggiungo ${snapshot.data![previousIndex].title}');
                                              box.put(
                                                  snapshot
                                                      .data![previousIndex].id,
                                                  snapshot
                                                      .data![previousIndex]);
                                            }
